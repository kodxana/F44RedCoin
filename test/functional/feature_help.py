...
"""Verify that starting f44redcoin with -h works as expected."""

from test_framework.test_framework import F44RedCoinTestFramework
from test_framework.util import assert_equal

class HelpTest(F44RedCoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start f44redcoin with -h for help text")
        ...
        self.log.info("Start f44redcoin with -version for version information")
        ...
        self.log.info("Start f44redcoind with -fakearg to make sure it does not start")
