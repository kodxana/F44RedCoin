...
class P2PPermissionsTests(F44RedCoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].f44redcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].f44redcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
