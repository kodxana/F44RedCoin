...
class PSBTTest(F44RedCoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 F44Coins
        ...
        # feeRate of 0.1 F44Coins / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 F44Coins / KB produces a total fee well above -maxtxfee
