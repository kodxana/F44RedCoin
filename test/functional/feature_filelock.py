...
"""Check that it's not possible to start a second f44redcoind instance using the same datadir or wallet."""
import os

from test_framework.test_framework import F44RedCoinTestFramework
from test_framework.test_node import ErrorMatch

class FilelockTest(F44RedCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that we can't start a second f44redcoind instance using the same datadir")
        ...
        if self.is_wallet_compiled():
            ...
            self.log.info("Check that we can't start a second f44redcoind instance using the same wallet")
