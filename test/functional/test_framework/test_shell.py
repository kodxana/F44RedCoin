...
class TestShell:
    """Wrapper Class for F44RedCoinTestFramework.

    The TestShell class extends the F44RedCoinTestFramework
    ...
    class __TestShell(F44RedCoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by F44RedCoinTestFramework child class.
            self.num_nodes = 1
