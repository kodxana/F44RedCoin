...
By default, f44redcoind will dump mempool on shutdown and
...
class MempoolPersistTest(F44RedCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent f44redcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
