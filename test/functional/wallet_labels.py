#!/usr/bin/env python3
# Copyright (c) 2016-2020 The F44RedCoin Core developers
...
class WalletLabelsTest(F44RedCoinTestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 F44RedCoins
