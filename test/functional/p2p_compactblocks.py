...
# TestP2PConn: A peer we use to send messages to f44redcoind, and store responses.
...
class CompactBlocksTest(F44RedCoinTestFramework):
    ...
    # This test actually causes f44redcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that f44redcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for f44redcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        version = test_node.cmpct_version
        node = self.nodes[0]
        # f44redcoind will not send blocktxn responses for blocks whose height is
