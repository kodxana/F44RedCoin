...
class FullBlockTest(F44RedCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure f44redcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure f44redcoind isn't accepting b28
        ...
        # f44redcoind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the f44redcoin code has custom code which does so);
