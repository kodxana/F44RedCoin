Contributing to F44RedCoin Core
============================

The F44RedCoin Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/f44redcoin/f44redcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [F44RedCoin Core PR Review Club](https://f44redcoincore.reviews/) meeting.

Communication Channels
----------------------

Most communication about F44RedCoin Core development happens on IRC, in the
#f44redcoin-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/f44redcoin-core-dev/](http://www.erisian.com.au/f44redcoin-core-dev/)
and [http://gnusha.org/f44redcoin-core-dev/](http://gnusha.org/f44redcoin-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/f44redcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to f44redcoin-qt
...
[Translation Process](https://github.com/f44redcoin/f44redcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the F44RedCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall F44RedCoin
Network Protocol consensus changes.

Whether a pull request is merged into F44RedCoin Core rests with the project merge
...
Patches that change F44RedCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the F44RedCoin consensus, it must have been
...
https://github.com/f44redcoin/f44redcoin/pull/16189).

Also see the [backport.py script](
https://github.com/f44redcoin-core/f44redcoin-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each F44RedCoin Core release.
