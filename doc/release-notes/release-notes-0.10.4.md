F44RedCoin Core version 0.10.4 is now available from:

  <https://f44redcoin.org/bin/f44redcoin-core-0.10.4/>
...
- #6953 `43c2789` Split f44redcoin-tx into its own package
- #6953 `dfe0d4d` Include f44redcoin-tx binary on Debian/Ubuntu
