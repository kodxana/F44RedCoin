F44RedCoin Core version 0.16.1 is now available from:

  <https://f44redcoincore.org/bin/f44redcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting f44redcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure f44redcoind processes are cleaned up when tests end (sdaftuar)
