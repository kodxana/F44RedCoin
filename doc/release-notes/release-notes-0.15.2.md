F44RedCoin Core version *0.15.2* is now available from:

  <https://f44redcoincore.org/bin/f44redcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in f44redcoin-tx (TheBlueMatt)
