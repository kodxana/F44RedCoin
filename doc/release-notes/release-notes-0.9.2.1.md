F44RedCoin Core version 0.9.2.1 is now available from:

  https://f44redcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 F44Coins to 0.01 F44Coins
...
- Fix "Start f44redcoin on system login"
