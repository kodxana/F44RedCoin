F44RedCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/f44redcoin/files/F44RedCoin/f44redcoin-0.5.4/
...
http://gitorious.org/f44redcoin/f44redcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix F44RedCoin-Qt notifications under Growl 1.3.
Increase required age of F44RedCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxF44RedCoin properly when installing F44RedCoin-Qt over it. (Windows)
