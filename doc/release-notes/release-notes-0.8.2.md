F44RedCoin-Qt version 0.8.2 is now available from:
  http://sourceforge.net/projects/f44redcoin/files/F44RedCoin/f44redcoin-0.8.2/
...
MacOSX:
* OSX support for click-to-pay (f44redcoin:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the F44RedCoin-Qt debug
console will cause F44RedCoin-Qt to crash. Run F44RedCoin-Qt with the -server command-line
