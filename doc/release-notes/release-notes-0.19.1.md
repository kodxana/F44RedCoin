...
F44RedCoin Core version 0.19.1 is now available from:

  <https://f44redcoincore.org/bin/f44redcoin-core-0.19.1/>
...
From F44RedCoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as F44RedCoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, F44RedCoin Core does not yet change appearance when
...
- #17488 fix "f44redcoind already running" warnings on macOS (fanquake)
