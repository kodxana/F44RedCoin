F44RedCoin Core version 0.11.1 is now available from:

  <https://f44redcoin.org/bin/f44redcoin-core-0.11.1/>
...
(see https://github.com/f44redcoin/f44redcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libf44redcoinconsensus: avoid a crash in multi-threaded environments
