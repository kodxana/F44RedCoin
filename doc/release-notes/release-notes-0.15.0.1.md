F44RedCoin Core version *0.15.0.1* is now available from:

  <https://f44redcoin.org/bin/f44redcoin-core-0.15.0.1/>

and

  <https://f44redcoincore.org/bin/f44redcoin-core-0.15.0.1/>
