F44RedCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/f44redcoin/files/F44RedCoin/f44redcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the F44RedCoin
...
New/changed settings (command-line or f44redcoin.conf file)
--------------------------------------------------------
