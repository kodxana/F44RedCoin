F44RedCoin Core version 0.9.4 is now available from:

  https://f44redcoin.org/bin/0.9.4/
...
this update is incompatible with the F44RedCoin system and could lead to consensus
forks.

F44RedCoin Core released binaries from https://f44redcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~f44redcoin/+archive/ubuntu/f44redcoin
- A third-party or self-compiled F44RedCoin Core

upgrade to F44RedCoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
