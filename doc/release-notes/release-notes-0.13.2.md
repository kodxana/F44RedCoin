F44RedCoin Core version 0.13.2 is now available from:

  <https://f44redcoin.org/bin/f44redcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update f44redcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow f44redcoin-tx to create v2 transactions (F44Coinsdrak)
