...
By default, F44RedCoin Core allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that f44redcoin's trustless model works best if you are
