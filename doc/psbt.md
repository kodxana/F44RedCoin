# PSBT Howto for F44RedCoin Core

Since F44RedCoin Core 0.17, an RPC interface exists for Partially Signed F44RedCoin
Transactions (PSBTs, as specified in
[BIP 174](https://github.com/f44redcoin/bips/blob/master/bip-0174.mediawiki)).
...
PSBT is an interchange format for F44RedCoin transactions that are not fully signed
...
#### Multisig with multiple F44RedCoin Core instances

Alice, Bob, and Carol want to create a 2-of-3 multisig address. They're all using
F44RedCoin Core. We assume their wallets only contain the multisig funds. In case
they also have a personal wallet, this can be accomplished through the
multiwallet feature - possibly resulting in a need to add `-rpcwallet=name` to
the command line in case `f44redcoin-cli` is used.
...
Later, when *V* F44Coins has been received on *Amulti*, and Bob and Carol want to
