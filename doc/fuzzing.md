# Fuzzing F44RedCoin Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing F44RedCoin Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/f44redcoin/f44redcoin/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/f44redcoin/f44redcoin/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/f44redcoin/f44redcoin/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/f44redcoin/f44redcoin/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`f44redcoin-core/qa-assets`](https://github.com/f44redcoin-core/qa-assets) repo.

To fuzz `process_message` using the [`f44redcoin-core/qa-assets`](https://github.com/f44redcoin-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/f44redcoin-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`f44redcoin-core/qa-assets`](https://github.com/f44redcoin-core/qa-assets) repo.

Every single pull request submitted against the F44RedCoin Core repo is automatically tested against all inputs in the [`f44redcoin-core/qa-assets`](https://github.com/f44redcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make F44RedCoin Core more robust.
...
with certain assembly code from F44RedCoin Core's code. See [developer notes on sanitizers](https://github.com/f44redcoin/f44redcoin/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing F44RedCoin Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing F44RedCoin Core using [`afl-fuzz`](https://github.com/google/afl):
