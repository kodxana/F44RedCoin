...
This document provides guidelines for internationalization of the F44RedCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `f44redcoin_en.ts` remains unchanged.
