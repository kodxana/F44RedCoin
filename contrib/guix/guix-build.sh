...
# Deterministically build F44RedCoin Core for HOSTs (overriable by environment)
for host in ${HOSTS=x86_64-linux-gnu arm-linux-gnueabihf aarch64-linux-gnu riscv64-linux-gnu}; do
    ...
    time-machine environment --manifest="${PWD}/contrib/guix/manifest.scm" \
                             ...
                             -- env HOST="$host" \
                                  ...
                                  bash -c "cd /f44redcoin && bash contrib/guix/libexec/build.sh"
