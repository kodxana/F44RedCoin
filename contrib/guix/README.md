# Bootstrappable F44RedCoin Core Builds

This directory contains the files necessary to perform bootstrappable F44RedCoin
Core builds.
...
- 24GB of free disk space on the partition that the F44RedCoin Core git repository
  resides in
...
For a F44RedCoin Core depends development environment, simply invoke
...
From the top of a clean F44RedCoin Core repository:
...
To use dongcarl's substitute server for F44RedCoin Core builds after having
