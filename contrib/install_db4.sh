...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the f44redcoin repository."
  exit 1
fi
...
# See https://github.com/f44redcoin/f44redcoin/issues/16064
...
echo 'When compiling f44redcoind, run `./configure` in the following way:'
echo
