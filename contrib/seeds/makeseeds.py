...
def main():
    ...
    # Filter out hosts with multiple f44redcoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print('%s Filter out hosts with multiple f44redcoin ports' % (ip_stats(ips)), file=sys.stderr)
