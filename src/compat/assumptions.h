...
#ifndef F44REDCOIN_COMPAT_ASSUMPTIONS_H
#define F44REDCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "F44RedCoin cannot be compiled without assertions."
#endif
...
#endif // F44REDCOIN_COMPAT_ASSUMPTIONS_H
