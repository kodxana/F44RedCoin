...
//! Entry point for F44RedCoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &F44RedCoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for F44RedCoinGUI tests.
void AppTests::guiTests(F44RedCoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &F44RedCoinGUI::consoleShown, this, &AppTests::consoleTests);
