    ...
    platformStyle(_platformStyle)
{
    ...
    // normal f44redcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying f44redcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &F44RedCoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
