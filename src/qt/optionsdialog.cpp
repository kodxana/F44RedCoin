    ...
    mapper(nullptr)
{
    ...
    ui->f44redcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->f44redcoinAtStartup);
    ...
    ui->f44redcoinAtStartup->setToolTip(ui->f44redcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->f44redcoinAtStartup->setText(ui->f44redcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openF44RedCoinConfButton->setToolTip(ui->openF44RedCoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new F44RedCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->f44redcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openF44RedCoinConfButton_clicked()
{
