...
#ifndef F44REDCOIN_UTIL_MESSAGE_H
#define F44REDCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's f44redcoin address, it must refer to a public key.
...
#endif // F44REDCOIN_UTIL_MESSAGE_H
