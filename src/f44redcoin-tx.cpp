...
static void SetupF44RedCoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " f44redcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  f44redcoin-tx [options] <hex-tx> [commands]  Update hex-encoded f44redcoin transaction\n" +
            "or:     f44redcoin-tx [options] -create [commands]   Create hex-encoded f44redcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded f44redcoin transaction
