...
#ifndef F44REDCOIN_INTERFACES_NODE_H
#define F44REDCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a f44redcoin node (f44redcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // F44REDCOIN_INTERFACES_NODE_H
