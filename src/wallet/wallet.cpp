...
bool CWallet::AddToWallet(const CWalletTx& wtxIn, bool fFlushOnClose)
{
    ...
    if (!strCmd.empty())
    {
        ...
        // https://github.com/f44redcoin/f44redcoin/pull/13339#issuecomment-537384875
        // A few ways it could be implemented in the future are described in:
        // https://github.com/f44redcoin/f44redcoin/pull/13339#issuecomment-461288094
...
{
    // If wallet doesn't have a chain (e.g f44redcoin-wallet), lock can't be taken.
...
void CWallet::transactionRemovedFromMempool(const CTransactionRef& tx, MemPoolRemovalReason reason) {
    ...
    if (reason == MemPoolRemovalReason::CONFLICT) {
        ...
        //    https://github.com/f44redcoin/f44redcoin/pull/18600#discussion_r420195993.
        ...
        //    https://github.com/f44redcoin/f44redcoin/pull/9371 and the prior sync
        ...
        // https://github.com/f44redcoin-core/f44redcoin-devwiki/wiki/Wallet-Transaction-Conflict-Tracking
        SyncTransaction(tx, {CWalletTx::Status::UNCONFIRMED, /* block height */ 0, /* block hash */ {}, /* index */ 0});
    }
}
    ...
    while (block_height && !fAbortRescan && !chain().shutdownRequested()) {
        ...
        if (chain().findBlock(block_hash, &block) && !block.IsNull()) {
            ...
            if (!locked_chain->getBlockHeight(block_hash)) {
                ...
                // https://github.com/f44redcoin/f44redcoin/pull/14711#issuecomment-458342518
                         ...
                         int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    int nBytes;
    {
        ...
        LOCK(cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-f44redcoin-address
...
DBErrors CWallet::LoadWallet(bool& fFirstRunRet)
{
    ...
    // tx status. If lock can't be taken (e.g f44redcoin-wallet), tx confirmation
 ...
 * https://f44redcointalk.org/?topic=54527, or
 * https://github.com/f44redcoin/f44redcoin/pull/1393.
 */
