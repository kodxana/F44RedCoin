...
#ifndef F44REDCOIN_WALLET_WALLET_H
#define F44REDCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this f44redcoin node, and set to 0 for transactions that were created
...
#endif // F44REDCOIN_WALLET_WALLET_H
