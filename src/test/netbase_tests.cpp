...
{
    BOOST_CHECK(TestSplitHost("www.f44redcoincore.org", "www.f44redcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.f44redcoincore.org]", "www.f44redcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.f44redcoincore.org:80", "www.f44redcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.f44redcoincore.org]:80", "www.f44redcoincore.org", 80));
