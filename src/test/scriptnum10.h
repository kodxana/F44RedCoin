...
#ifndef F44REDCOIN_TEST_SCRIPTNUM10_H
#define F44REDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from F44RedCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // F44REDCOIN_TEST_BIGNUM_H
