...
// f44redcoin includes.
#include <..\src\script\f44redcoinconsensus.h>
...
int main()
{
    std::cout << "f44redcoinconsensus version: " << f44redcoinconsensus_version() << std::endl;
    ...
    auto op0Result = f44redcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, f44redcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
